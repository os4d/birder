# Generated by Django 5.1.4 on 2024-12-24 21:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("program", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="birder.project")),
            ...
            options={
                "constraints": [
                    models.UniqueConstraint(
                        ...
                        name="unique_project_monitor_name",
                    )
                ],
            },
        ),
